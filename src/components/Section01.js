...
const UpSection = () => {
  return (
    <div>
        <div className="w-full h-full bg-top bg-fixed  bg-no-repeat bg-cover bg-Baner">
            ...
            <div 
                ...
                data-aos="fade-left" data-aos-offset="50" data-aos-easing="ease-in-sine" data-aos-duration="800">
        ...
        <div 
            ...
            data-aos="flip-down" data-aos-offset="50" data-aos-easing="ease-in-sine" data-aos-duration="500">
