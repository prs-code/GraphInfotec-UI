...
const UpSection = () => {
  return (
    <div>
        <div className="w-[100vw] h-[100vh] bg-top bg-fixed  bg-no-repeat bg-cover bg-Baner">
            ...
            <Navbar />
            <div 
                className="py-20 mb-20 text-gray-200 m-14"
                data-aos="fade-left" data-aos-offset="50" data-aos-easing="ease-in-sine" data-aos-duration="1500">
                <h1 className="text-3xl font-semibold">
                        سامانه مدیریت فرآیندهای کسب و کار گراف</h1>
        ...
        <div 
            className="text-center text-white py-6 z-10 w-[90%] bg-[#CD2122] m-auto mt-[-110px] mb-10 border-t-[3px] border-white rounded-lg"
            data-aos="flip-down" data-aos-offset="50" data-aos-easing="ease-in-sine" data-aos-duration="1000">
