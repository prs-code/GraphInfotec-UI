...
const ContactUs = () => {
  ...
  return (
    <div className="fixed left-0 right-0 z-10 h-full md:h-screen w-screen bg-center bg-repeat md:bg-no-repeat md:bg-cover bg-contain bg-Baner">
      <div className="z-50 flex flex-col absolute inset-10 border-[1px] border-[rgb(204, 204, 204)] md:overflow-hidden md:justify-center rounded outline-0 p-5">
